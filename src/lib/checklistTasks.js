...
export const KDP_PHASES = [
  {
    ...
    color: 'cyan',
    tasks: [
      { id: 't40', title: 'KDPアカウントの本人情報・税務・支払設定と、配信方法を確認する', tool: 'KDPアカウント / 配信日オプション', note_default: '初出版の場合は早めに準備。発売日の購入を集めたい場合、予約注文は発売前からランキング等へ反映され、発売日にまとめて再加算される保証がない点も確認', important: true },
